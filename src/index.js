...
const createFileFilter = (acceptedFileTypes = []) => {
  return (req, file, cb) => {
...
const createDiskStorage = ({ path, fileName }) => {
...
// Disk upload configuration with options including maxSize as a string (e.g., "5mb")
const uploadDisk = (options = {}) => {
  const {
    path,
    fileName = null,
    acceptedFileTypes = [],
...
// Memory upload configuration with options including maxSize as a string
const uploadMemory = (options = {}) => {
